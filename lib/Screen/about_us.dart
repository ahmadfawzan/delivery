      ...
      body:PageView.builder(
          ...
          itemBuilder: (context, index){
            ...
            return  SingleChildScrollView(
              ...
              Stack(
                children: [
                  ImageWidget(image:pages[index].image ,height: 400,width: double.infinity,fit: BoxFit.cover,),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const TextWidgets(text: 'Skip',fontSize: 17,color:Colors.white ,textDecoration: TextDecoration.none,),
                        IconButton(icon:const Icon(Icons.arrow_forward_ios,),color:Colors.white ,iconSize: 17, onPressed:(){   Navigator.of(context).push(MaterialPageRoute(builder: (context) => const AboutUs(),));} ),
                      ],
                    ),
                  ),
                 Container(
              ...
              TextWidgets(text: pages[index].title,fontSize: 25,fontWeight: FontWeight.bold,),
              ...
              child:  TextWidgets(text:countIndex==pages.length-1 ? 'Get Started':'Next', fontSize: 20, fontWeight: FontWeight.bold)
              )
              ],
              ),
              ),
